...
public class StreakFlareRendererFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    private StreakFlareRenderPass m_StreakFlarePass;
    ...
    {
        m_StreakFlarePass = new StreakFlareRenderPass(m_passSettings);
    }
    ...
    )
    {
        ...
        if (
            !renderingData.cameraData.isSceneViewCamera && !renderingData.cameraData.isPreviewCamera
        )
        {
            renderer.EnqueuePass(m_StreakFlarePass);
        }
    }
}
