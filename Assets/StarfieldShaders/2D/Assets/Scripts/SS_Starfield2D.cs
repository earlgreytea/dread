...
public class SS_Starfield2D : SS_AGenerator2D
{
    ...
    protected override void ParallaxEffect()
    {
        ...
        MyMaterial.SetVector(
            "_Offset",
            new Vector4(offsetX, offsetY, starfieldBounds.x, starfieldBounds.y)
        );
    }
    ...
    {
        MyMesh = SS_Starfield2DMesh.GenerateMesh(
            seed,
            matchAspectRatio ? GetAspectRatioDetailX : detailX,
            detailY,
            gradient,
            perlinAmount,
            uniformColor,
    ...
    private void SetStyleShaderKeyword()
    {
        string activeStyle =
            style == Style.Normal
                ? styleKeywordPrefix + style.ToString().ToUpper()
                : styleKeywordPrefix + "POLY";
    ...
    /// </summary>
    public void SetNoiseToMesh(int _seed)
    {
        seed = _seed;
        SetNoiseToMesh();
    }
    ...
    public void SetNoiseToMesh()
    {
        ...
        mesh.uv = uv;
        mesh.uv2 = uv2;
        mesh.uv3 = SS_Starfield2DMesh.GetOffsetNoise(
            seed,
            detailX,
            detailY,
            mesh.vertices,
    ...
    /// Sets seed equal to _seed;
    /// </summary>
    public void SetColorsToMesh(int _seed)
    {
        seed = _seed;
        SetColorsToMesh();
    }
    ...
    {
        MyMesh.colors = SS_Starfield2DMesh.GetColors(
            seed,
            detailX,
            detailY,
            gradient,
